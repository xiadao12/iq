...
public class StrategyContinuousOverOTC {
    ...
    public void execute(List<CandlesResponse.Candle> candles, Object strategyFilterObject) {
        ...
        for(CandlesResponse.Candle candle : candles){
            ...
            //判断是否是周末蜡烛
            Boolean weekCandle = judgeOTCTime(candle.getTo() * 1000);
                    ...
                    for (BigDecimal allFactor = new BigDecimal(0.0001);
                        ...
                        for (BigDecimal reverseFactor = new BigDecimal(0.00001);
                            ...
                            for (int k = 0; k < weekCandles.size() - delayMinutes; k++) {
                                ...
                                //判断是否是第一个蜡烛或者符合周末时间
                                if (k == 0 || !judgeOTCTime(candle.getTo() * 1000)) {
     ...
     * @return
     */
    public static Boolean judgeOTCTime(Long time) {
        ...
        if (weekDay.equals(7) && dateTimeString.compareTo("08:00:00") >= 0) {
            return true;
        }
        ...
        //如果是周一，则小于04:00:00
        if (weekDay.equals(2) && dateTimeString.compareTo("04:00:00") <= 0) {
            return true;
        }
